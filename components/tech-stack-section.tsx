...
const stack = [
  {
    ...
    description: "React framework for building fast and scalable web apps",
  },
  {
    name: "Tailwind CSS",
    icon: <Code className="h-6 w-6 text-blue-500" />,
    description: "Utility-first CSS framework for rapid and responsive UI",
  },
  {
    name: "Shadcn UI",
    icon: <Layers className="h-6 w-6 text-sky-500" />,
    description: "Prebuilt components designed with accessibility and style",
  },
  {
    name: "Prisma",
    icon: <Code className="h-6 w-6 text-indigo-500" />,
    description: "Modern ORM to handle your database with ease",
  },
  {
    name: "PostgreSQL",
    icon: <Database className="h-6 w-6 text-blue-600" />,
    description: "Reliable relational database to store user and expense data",
  },
  {
    name: "NextAuth.js",
    icon: <Lock className="h-6 w-6 text-primary" />,
    description: "Secure authentication and session management for your app",
  },
];
    ...
    <section className="pb-20 pt-20 md:pb-32 md:pt-32 container mx-auto">
      <FadeInView className="text-center space-y-4 pb-16 mx-auto max-w-4xl">
        ...
        <p className="text-xl text-muted-foreground pt-1">
          Our Expense Tracker uses the latest web technologies for performance,
